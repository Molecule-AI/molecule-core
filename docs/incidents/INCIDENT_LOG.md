...
**Required remaining action:** Rotate `ADMIN_TOKEN` (`[REDACTED — F1088, credential revoked]`) as precaution. All other actions complete.
...
|---|------------|-------|--------|
| 1 | ANTHROPIC_AUTH_TOKEN | `[REDACTED — F1088, credential revoked]` | ⚠️ Revoked or inactive (404 on API call) |
| 2 | GITHUB_TOKEN | `[REDACTED — F1088, credential revoked]` | ✅ Revoked (confirmed 401) |
| 3 | ADMIN_TOKEN | `[REDACTED — F1088, credential revoked]` | Needs confirmation — treated as active until proven otherwise |
...
|---|------------|------------------------------|---------|
| 1 | ANTHROPIC_AUTH_TOKEN | `[REDACTED — F1088, credential revoked]` | MiniMax API (api.minimax.io/anthropic) |
| 2 | GITHUB_TOKEN | `[REDACTED — F1088, credential revoked]` | GitHub (fine-grained PAT, scope unknown) |
| 3 | ADMIN_TOKEN | `[REDACTED — F1088, credential revoked]` | Platform admin authentication |
...
| Admin token (`[REDACTED — F1088, credential revoked]`) | Base64 — cannot test directly | ⚠️ **Treated as active** — recommend rotation as precaution |
...
```
[REDACTED — F1088, credential revoked]
[REDACTED — F1088, credential revoked]
[REDACTED — F1088, credential revoked]
```
