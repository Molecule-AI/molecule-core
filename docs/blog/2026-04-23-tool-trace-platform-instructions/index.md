...
og_image: /assets/phase34-tool-trace-platform-instructions.png
...
Together, they address the two questions enterprise teams ask first when evaluating an AI agent platform: *what did the agent actually do?* and *can we enforce policy at the platform level?* For the full tool-call record, see [Tool Trace: AI Agent Observability Without the Overhead](/blog/ai-agent-observability-without-overhead/).
