...
**LangGraph A2A status:** PRs #6645, #7113 (still in review 3+ months as of Apr 22) — protocol layer only, no governance.
...
| 2026-04-22 | Last ecosystem-watch.md snapshot | Research Lead update |

---

*Source: `ecosystem-watch.md` competitor-snapshot block (Molecule-AI/internal), updated 2026-04-22*
*Generated by: PMM cron*
*Next update: when ecosystem-watch.md `date` + `notable_changes` fields change*