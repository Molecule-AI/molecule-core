...
3. `docs/blog/2026-04-20-mcp-server-list/` — MCP server ecosystem guide ✅ **SOURCE AUDIT COMPLETE** (see `2026-04-21-mcp-server-list-lighthouse-audit.md`). BLOCKED: page not deployed, OG image missing.
...
9. `docs/blog/2026-04-XX-external-workspaces-polling/` — ⚠️ PRE-POSITIONING BRIEF DONE — do NOT audit until `molecule-external-agent` ships on PyPI + `/docs/guides/external-workspaces-polling.md` published
