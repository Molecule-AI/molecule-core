# Social Queue — 2026-04-22 (Updated)

**Campaign:** Discord Adapter Launch
**Blog:** https://docs.molecule.ai/blog/discord-adapter
**Status:** ✅ Ready to post — blog confirmed live (PR #1301)
**Note:** Fly Deploy Anywhere (Apr 17) also queued — blog live, social copy ready, see campaign table below.
**Assets:** `marketing/devrel/campaigns/discord-adapter-launch/assets/`

---



| Day | Date | Campaign | Source | Status |
|-----|------|----------|---------|--------|
| Day 2 | Apr 22 | A2A v1 Deep-Dive | a2a-v1-deep-dive/social-copy.md | ✅ Ready — just committed (staging) |
| Day 3 | Apr 23 | Org API Keys | org-api-keys-announcement/social-copy.md | ✅ Ready |
| Day 3 | Apr 23 | A2A Enterprise | a2a-enterprise-launch/social-copy.md | ✅ Ready |
| Day 4 | Apr 24 | EC2 Instance Connect SSH | ec2-instance-connect-ssh/social-copy.md | ✅ Ready |
| Day 5 | Apr 25 | MCP Server List | mcp-server-list/social-copy.md | ✅ Ready |
| Apr 21–25 | Apr 21–25 | Cloudflare Artifacts | cloudflare-artifacts-launch/social-copy.md | ✅ Ready — blog live |
| Apr 17+ | Apr 17+ | Fly Deploy Anywhere | fly-deploy-anywhere/social-copy.md | ✅ DRAFT — blog live Apr 17, social copy ready, needs final review |
...
**Assets:** discord-molecule-logo-combo.png, discord-slack-command-mockup.png, discord-community-signal-flow.png
