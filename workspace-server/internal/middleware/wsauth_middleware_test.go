...
// orgTokenValidateQueryWithOrgID is matched for orgtoken.Validate() — includes org_id column.
const orgTokenValidateQueryWithOrgID = "SELECT id, prefix, org_id::text FROM org_api_tokens"
...
func TestAdminAuth_OrgToken_SetsOrgID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mock.ExpectQuery(orgTokenValidateQueryWithOrgID).
