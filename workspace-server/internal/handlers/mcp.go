...
// Tool implementations (toolListPeers, toolGetWorkspaceInfo, toolDelegateTask,
// toolDelegateTaskAsync, toolCheckTaskStatus, toolSendMessageToUser,
// toolCommitMemory, toolRecallMemory), URL resolution helpers (mcpResolveURL,
// extractA2AText), and SSRF checks live in mcp_tools.go.
