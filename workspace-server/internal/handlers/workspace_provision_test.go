...
// Skipped regression tests for issue #1206 (err.Error() leak prevention) were
// removed alongside their unused captureBroadcaster / mockEnvMutator /
// mockPluginsSources / mockResolver helpers — the helpers had type-mismatch
// bugs versus the production handlers and the tests were t.Skip()'d. Re-add
// once the broadcaster / plugins.Registry interfaces are refactored.
